...
async function activarReproduccion() {
    ...
    if (userID && filmID) {
        ...
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/film/${encodeURIComponent(filmID)}/play`, {
...
async function pausarReproduccion() {
    ...
    if (userID && filmID) {
        // Llamar a la URL para obtener los datos de reproducción
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/film/${encodeURIComponent(filmID)}/pause`, {
                method: 'POST',  // Usamos POST para iniciar la reproducción
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
...
async function finalizarReproduccion() {
    ...
    const filmID = new URLSearchParams(window.location.search).get("filmID"); // Obtener filmID de los parámetros de la URL
    ...
    try {
        const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/film/${encodeURIComponent(filmID)}/end`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
async function descargarReproduccion() {
    ...
    try {
        const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/film/${encodeURIComponent(filmID)}/download`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
async function españolReproduccion() {
    ...
    if (userID && filmID) {
        ...
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/film/${encodeURIComponent(filmID)}/language`, {
                method: 'POST',  // Usamos POST para iniciar la reproducción
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
...
async function subtitulosOnReproduccion() {
    ...
    if (userID && filmID) {
        ...
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/film/${encodeURIComponent(filmID)}/subtitles`, {
                method: 'POST',  // Usamos POST para iniciar la reproducción
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
