...
async function activarReproduccion() {
    ...
    if (userID && serieID) {
        ...
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/serie/${encodeURIComponent(serieID)}/play`, {
...
async function pausarReproduccion() {
    ...
    if (userID && serieID) {
        // Llamar a la URL para obtener los datos de reproducción
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/serie/${encodeURIComponent(serieID)}/pause`, {
                method: 'POST',  // Usamos POST para iniciar la reproducción
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
...
async function finalizarReproduccion() {
    ...
    try {
        const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/serie/${encodeURIComponent(serieID)}/end`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
async function descargarReproduccion() {
    ...
    try {
        const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/serie/${encodeURIComponent(serieID)}/download`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
async function españolReproduccion() {
    ...
    if (userID && serieID) {
        ...
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/serie/${encodeURIComponent(serieID)}/language`, {
                method: 'POST',  // Usamos POST para iniciar la reproducción
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
...
async function subtitulosOnReproduccion() {
    ...
    if (userID && serieID) {
        ...
        try {
            const response = await fetch(`/api/visualization/views/visualization/${encodeURIComponent(userID)}/serie/${encodeURIComponent(serieID)}/subtitles`, {
                method: 'POST',  // Usamos POST para iniciar la reproducción
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
