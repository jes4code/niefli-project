...
const obtenerInformacionActor = async () => {
    ...
    try {
        const response = await fetch(`/api/content/v1/content/actors/${actorID}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
...
const obtenerPeliculasActor = async (actorID) => {
    try {
        const response = await fetch(`/api/content/v1/content/films/actor/${actorID}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
...
const obtenerSeriesActor = async (actorID) => {
    try {
        const response = await fetch(`/api/content/v1/content/series/actor/${actorID}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
