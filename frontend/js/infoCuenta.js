...
const obtenerInformacionPago = async (userID) => {
    try {
        const response = await fetch(`/api/user/v1/user/user/${userID}/payment`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
...
const obtenerInformacionPlan = async (userID) => {
    try {
        const response = await fetch(`/api/user/v1/user/user/${userID}/getSuscripcionPlan`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
        ...
        const payment = await fetch(`/api/user/v1/user/user/${userID}/payment`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
