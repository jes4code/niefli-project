...
public class RecommendationDAO {
	...
	public List<Recomendacion> getFilms(int userID) {
		String userServiceUrl = userBaseUrl + "/v1/user/user/" + userID;
        String filmServiceUrl = contentBaseUrl + "/v1/content/films/genre/{genreID}";
	...
	public List<Recomendacion> getSeries(int userID) {
        ...
        String serieServiceUrl = contentBaseUrl + "/v1/content/series/genre/{genreID}";
